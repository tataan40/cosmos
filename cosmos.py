...
try:
    ...
    print
    "Error: Maxmind GeoIP Python Module is required and not installed. Please install from: https://github.com/maxmind/geoip-api-python"
    sys.exit()
try:
    from prettytable import PrettyTable
except ImportError:
    print
    "Error: PrettyTable is required and not installed. Please install it by running 'pip install prettytable'"
    sys.exit()
...
def geoip_query(ip_address):
    try:
        ...
        try:
            ...
            print
            "Please download and gunzip the latest version from http://geolite.maxmind.com/download/geoip/database/GeoLiteCity.dat.gz"
            sys.exit()
        ...
        try:
            ...
            print
            "Please download and gunzip the latest version from http://geolite.maxmind.com/download/geoip/database/asnum/GeoIPASNum.dat.gz"
            sys.exit()
...
def single_ip_print(single_ip_info):
    try:
        print
        "IP Address: " + single_ip_info[0]
        print
        "AS Number: " + single_ip_info[1]
        print
        "AS Name: " + single_ip_info[2]
        print
        "City: " + single_ip_info[3]
        print
        "Region: " + single_ip_info[4]
        print
        "Country: " + single_ip_info[5]
        print
        "Country Code: " + single_ip_info[6]
        print
        "Latitude: " + single_ip_info[7]
        print
        "Longitude: " + single_ip_info[8]
        print
        "Google Maps: " + single_ip_info[9]
        exit(1)
...
def print_table(ip_data_dict):
    try:
        ...
        print
        "There was a problem displaying the GeoIP data in a table format"
        print
        str(e)
